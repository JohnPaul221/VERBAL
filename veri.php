...
<head>
    ...
    <style>
        ...
        body {
            ...
            overflow: hidden; /* Tinanggal ang main scroll */
        }
        h2 {
        ...
        .page-header {
            /* Binawasan ang padding para hindi kumain ng space sa itaas */
            padding: 5px 0;
            margin: 0;
            min-height: 0;
        }
        #usernameDisplay {
            /* Nilipat sa loob ng main container area visually */
            position: absolute;
            top: 25px; /* Adjust base sa padding ng main-container */
            left: 35px;
            font-size: 0.95rem;
            font-weight: 700;
            color: #1e40af;
            ...
            z-index: 10; /* Para laging nasa ibabaw */
        ...
        .section h2 {
            margin-top: 10px; /* Dagdag space para sa mga titles */
        }
        .section {
            padding: 10px;
            border-radius: 10px;
        ...
        .section {
            flex: 1; /* Hahatiin ang space ng pantay-pantay */
            padding: 15px;
            border-radius: 10px;
            background-color: #f7fbff;
        ...
        @media (max-width: 1200px) {
            ...
            .main-container {
                max-width: 98vw; /* Mas malapad para sa tatlong columns */
                margin: 10px auto;
                height: 85vh; /* Fixed height para pantay ang bagsak ng dividers */
                display: flex;
                flex-wrap: nowrap;
                gap: 15px;
                background: #ffffff;
        ...
        @media (max-width: 1200px) {
            #usernameDisplay, #logoutBtn {
                position: static; /* Babalik sa normal flow sa mobile para hindi magulo */
                margin: 5px auto;
                width: fit-content;
                display: block;
            }
