...
<div class="leaderboard-container">
    ...
    <table id="leaderboard">
        ...
        <tbody>
        <?php
        // 1. Database Setup - Use the same config as save_rating.php
        require_once 'config/database.php';

        // NOTE: This assumes 'config/database.php' defines $servername, $username, $password, $dbname
        ...
        if ($conn->connect_error) {
            echo "<tr><td colspan='3'>🚨 Database connection failed: " . $conn->connect_error . "</td></tr>";
        } else {
            // 2. SQL Query to Calculate Total Points per Student
            $sql = "
                SELECT
                    username,
                    SUM(score) AS points
        ...
        // 3. Loop through the fetched data and generate the table rows
