...
<head>
    ...
    <style>
        ...
        :root {
            /* Colors based on Study.Pilot image */
            --brand-blue: #1a73e8; /* Bright Blue background */
            --accent-orange: #f9a825; /* Orange for buttons */
            --card-bg: #ffffff;
            --text-main: #1e293b;
            --border-radius: 24px;
        }
        ...
        body {
            min-height: 100vh;
            /* Bright blue gradient background from the image */
            background: linear-gradient(180deg, #0084ff 0%, #0056ff 100%);
        ...
        /* Main Container - Rounded & Clean like the cards in the image */
        .main-container {
            max-width: 1200px;
            width: 100%;
            display: grid;
            grid-template-columns: 1.2fr 2px 2fr 2px 0.8fr;
            gap: 20px;
        ...
        /* Buttons - 3D Orange Style (JOIN FOR FREE style) */
        button {
            padding: 14px 28px;
        ...
        .btn-primary, #nextBtn {
            background: linear-gradient(180deg, #ffb800 0%, #f9a825 100%);
            color: white;
            box-shadow: 0 4px 0 #c7861b; /* 3D effect */
        }

        .btn-primary:hover {
            transform: translateY(-2px);
            box-shadow: 0 6px 0 #c7861b;
        }

        .btn-primary:active {
            transform: translateY(2px);
            box-shadow: 0 2px 0 #c7861b;
        }
        ...
        /* Mic Button - Deep Blue/Purple Gradient */
        .mic-icon {
            width: 90px;
            height: 90px;
            background: linear-gradient(135deg, #1a73e8, #0056ff);
            border-radius: 50%;
            color: white;
            display: flex;
            align-items: center;
